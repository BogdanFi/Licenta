...
namespace Chess
{
    ...
    public partial class NebunCustomControl : UserControl
    {
        ...
        private void CreatePiece(int index, NebunCustomControl form)
        {
        ...
        private void MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (!FirstMouseClick)
            {
                if (piece.PiecePosition < BoardSizeC * 2)
                {
                    ...
                    label1.Text = "Selectați modul în care se va deplasa nebunul";
        ...
        {
            label1.Text = "Selectați poziția de start a nebunului";
            for (int i = 0; i < BoardSizeC * BoardSizeL; i++)
            {
