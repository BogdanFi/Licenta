...
namespace Chess
{
    ...
    public partial class TuraCustomControl : UserControl
    {
        ...
        private void CreatePiece(int index, TuraCustomControl form)
        {
        ...
        private void MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (!FirstMouseClick)
            {
                if (piece.PiecePosition < BoardSizeC * 2)
                {
                    ...
                    label1.Text = "Selectați modul în care se va deplasa tura";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (count >= 2)
            {
                ...
                DatePiesa.Save = true;
                DatePiesa.NumelePiesei = string.Copy("Tura");
        ...
        {
            label1.Text = "Selectați poziția de start a turei";
            for (int i = 0; i < BoardSizeC * BoardSizeL; i++)
            {
