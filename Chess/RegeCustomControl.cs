...
namespace Chess
{
    ...
    public partial class RegeCustomControl : UserControl
    {
        ...
        private void CreatePiece(int index, RegeCustomControl form)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (count >= 2)
            {
                ...
                DatePiesa.Save = true;
                DatePiesa.NumelePiesei = string.Copy("Regele");
        ...
        {
            label1.Text = "Selectați poziția de start a regelui";
            for (int i = 0; i < BoardSizeC * BoardSizeL; i++)
            {
